                    ...
                    if(move_uploaded_file($arqTemporario1, $dirArq.$slide1) && move_uploaded_file($arqTemporario2, $dirArq.$slide2)
                		...
                		&& move_uploaded_file($arqTemporarioMoba, $dirArq.$imgMoba) && move_uploaded_file($arqTempProp, $dirArq.$imgPropaganda)){
							...
							$sqli = "update tblQuemSomos set
                                ...
                                paragrafo1 = '".$conteudo1."',
                                paragrafo2 = '".$conteudo2."',
                                paragrafo3 = '".$conteudo3."',
                                paragrafo4 = '".$conteudo4."',
                                imgProgapanda = '".$imgPropaganda."',
                                loja1 = '".$localizacao1."',
                                loja2 = '".$localizacao2."',
                                loja3 = '".$localizacao3."'
                                where idVersao = ".$id;
		                    ...
		                    if(mysqli_query($conex,$sqli))
		                        ...
		                        location.href = 'cmsQuemSomos.php'
		                        </script>
		                        ");
		                    else
		                        echo("
